...
Geo3D::Asset::Import - The great new Geo3D::Asset::Import!
...
Perhaps a little code snippet.
    ...
    use Geo3D::Asset::Import;

    my $foo = Geo3D::Asset::Import->new();
    ...

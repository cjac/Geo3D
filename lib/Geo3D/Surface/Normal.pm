...
Geo3D::Surface::Normal - The great new Geo3D::Surface::Normal!
...
Perhaps a little code snippet.
    ...
    use Geo3D::Surface::Normal;

    my $foo = Geo3D::Surface::Normal->new();
    ...

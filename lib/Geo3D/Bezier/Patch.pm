...
Geo3D::Bezier::Patch - The great new Geo3D::Bezier::Patch!
...
Perhaps a little code snippet.
    ...
    use Geo3D::Bezier::Patch;

    my $foo = Geo3D::Bezier::Patch->new();
    ...
